...
import { isCheck } from '../components/patologie/patologieSlice';
  ...
  return (
    <div>
      <form className="border-blue-600/20 bg-blue-400/30 mb-3">
        ...
        <div className="flex justify-center">
          <label className="pr-2 m-1 w-11" htmlFor="nome">
            Nome
          </label>
          <input
            type="text"
            id="nome"
            className="bg-blue-400/20 m-1 mr-3 w-30"
          ></input>

          <label className="pr-2 m-1" htmlFor="cognome">
            Cognome
          </label>
          <input
            type="text"
            id="cognome"
            className="bg-blue-400/20 m-1 w-45 mr-3"
          ></input>

          <label className="pr-2 m-1" htmlFor="indirizzo">
            Indirizzo
          </label>
          <input
            type="text"
            id="indirizzo"
            className="bg-blue-400/20 m-1 mr-3"
          ></input>

          <label className="pr-2 m-1" htmlFor="codicefiscale">
            Codice Fiscale
          </label>
          <input
            type="text"
      ...
      <div className="flex">
        ...
        <form className="flex flex-col border-blue-600/20 bg-blue-400/30">
          ...
          <div className=" flex-1">
            <label className="pr-2 m-1" htmlFor="pressione">
              Pressione
            </label>
            <input
              type="text"
              id="pressione"
              className="bg-blue-400/20 m-1"
            ></input>
          </div>
          <div className=" flex-2">
            <label className="pr-4 m-1" htmlFor="glicemia">
              Glicemia
            </label>
            <input
              type="text"
